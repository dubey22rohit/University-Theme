        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <ul>
              ...
              <li <?php if(get_post_type() == 'events') echo 'class="current-menu-item"'?>><a href="<?php echo get_post_type_archive_link('events')?>">Events</a></li>
              <li <?php if(get_post_type() == 'campuses') echo 'class="current-menu-item"'?>><a href="<?php echo get_post_type_archive_link('campus')?>">Campuses</a></li>
