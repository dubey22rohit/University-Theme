...
?>
    <div class='container container--narrow page-section'>
        <div class="create-note">
            ...
            <span class="note-limit-message">Note Limit Reached : Please Delete Some Notes to Make Room For More</span>
        </div>
    </div>
    <div class="container container--narrow page-section">
        <ul class='min-list link-list' id='my-notes'>
            ...
            while ($user_notes->have_posts()) {
                ...
                <li data-id="<?php the_ID() ?>">
                    <input readonly class="note-title-field" value="<?php echo str_replace('Private: ', '', esc_attr(get_the_title())); //phpcs:ignore
                                                                    ?>">
