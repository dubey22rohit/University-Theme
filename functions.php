...
function university_custom_rest() {
    register_rest_field('post', 'authorName', array(
        'get_callback' => function () {
            return get_author_name(); //phpcs:ignore
        }
    ));
...
?>
    <div class="page-banner">
        <div class="page-banner__bg-image" style="background-image: url(<?php echo esc_attr($args['photo']) ?>);"></div>
...
function university_files() {
    wp_enqueue_script('main-university-js', get_template_directory() . '/js/scripts-bundled.js', null, 1.0, true);
    wp_enqueue_script('universityJS', get_template_directory_uri() . '/js/scripts.js', array(), '1.0');
...
add_filter('login_headererl', 'personalized_header');
function personalized_header() {
    return esc_url(site_url('/'));
}
add_action('login_enqueue_scripts', 'personalized_css');
function personalized_css() {
    wp_enqueue_style('university_main_styles', get_stylesheet_uri());
}
